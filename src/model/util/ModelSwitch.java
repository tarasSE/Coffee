...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.TEST_DIAGRAM: {
				TestDIagram testDIagram = (TestDIagram)theEObject;
				T result = caseTestDIagram(testDIagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.COFFEE: {
				Coffee coffee = (Coffee)theEObject;
				T result = caseCoffee(coffee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CUP: {
				Cup cup = (Cup)theEObject;
				T result = caseCup(cup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.WATER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test DIagram</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test DIagram</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTestDIagram(TestDIagram object) {
		return null;
	}
